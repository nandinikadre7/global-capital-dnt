              ...
              >
                ...
                <div className="relative w-full mb-5 bg-stone-200">
                  <Image
                    ...
                    width={400}
                    height={450}
                    className="w-full h-80 object-top object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                  ...
                  {member.email && (
                    <div className="absolute inset-0 bg-brand-navy/85 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-3 p-4">
                      <a
                        ...
                        className="text-white text-xs tracking-wide hover:text-brand-gold transition-colors text-center break-all"
                      >
                        {member.email}
                      </a>
                      {member.phone && (
                        <a
                          ...
                          className="text-stone-300 text-sm hover:text-brand-gold transition-colors"
                        >
                          {member.phone}
                        </a>
                      )}
                ...
                <p className="font-serif text-lg text-brand-charcoal mb-0.5 text-center">
                  {member.name}
                </p>
                <p className="text-brand-gold text-xs tracking-widest uppercase mb-1 text-center">
                  {member.role}
                </p>
