...
export const metadata = {
  title: "Project Owners | Global Investor Circle",
  description: "Register as a Project Owner with Global Investor Circle.",
};
      ...
      <div className="bg-brand-navy pt-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-20">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="overline-label text-brand-gold">Project Owners</span>
          </div>
          <h1 className="font-serif text-5xl md:text-6xl text-white leading-tight max-w-xl">
            Register as a Project Owner
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-3 bg-white border border-stone-200 p-8 md:p-10">
              <p className="font-serif text-2xl text-brand-charcoal mb-2">Project Owner Registration</p>
